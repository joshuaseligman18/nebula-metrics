...
/// Struct representing process information from both the PROCESS and PROCSTAT tables
#[derive(Debug, Serialize, FromRow, Clone)]
#[sqlx(rename_all = "UPPERCASE")]
pub struct CombinedProcessInfo {
    ...
    /// Unix epoch timestamp at which the entry was recorded in PROCSTAT table
    pub procstat_timestamp: i64,
    /// Total CPU time for the process in seconds
    pub total_cpu: f32,
    /// Percent of CPU time since the last metric check
    pub percent_cpu: Option<f32>,
